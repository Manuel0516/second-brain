...
- Read `docs/public/architecture.md` for the system map.
- Read `docs/public/self-hosting.md` for deployment and security constraints.
...
- Preserve the configurable `APP_HOST`, the `letsencrypt` resolver, and the
  Traefik Hub label contract.
